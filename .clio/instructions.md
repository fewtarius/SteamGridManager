...
**Format:**
- `YYYYMMDD` = Date (e.g., `20260316`)
- `HHMM` = Time in UTC (e.g., `1418` for 14:18)
...
1. **What Was Accomplished** - Completed tasks, code changes, tests run
2. **Current State** - Git activity, files modified, known issues
3. **What's Next** - Priority tasks with specifics
...
1. **Work Prioritization Matrix** - Priority, Task, Time, Status, Blocker
2. **Task Breakdown** - Status, Effort, Dependencies, Steps, Files, Success criteria
...
- **AFTER EACH TOOL CALL: Always process and synthesize the results**
